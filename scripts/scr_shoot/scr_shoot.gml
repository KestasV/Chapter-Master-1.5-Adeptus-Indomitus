        ...
        if ((weapon_index_position >= 0) && instance_exists(target_object) && (owner == 2)) {
            ...
            if ((damage_type == "status") && (stop == 0) && (shots_fired > 0)) {
                ...
                if ((hit_number > 0) && (melee_or_ranged != "wall") && instance_exists(target_object)) {
                    ...
                    scr_clean(target_object, hostile_type, hit_number, (hostile_damage * _range_mult), hostile_weapon, hostile_range, hostile_splash, weapon_index_position, armour_pierce, _shot_dist, (melee_or_ranged == "melee"));
                }
